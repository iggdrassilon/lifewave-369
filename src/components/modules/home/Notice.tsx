        ...
        <div className='bg-blue-700 max-h-[600px]'>
          ...
          <div
            ...
            style={{
              ...
              background:
                'linear-gradient(to bottom, rgba(250,120,250, .3), rgba(0,0,0, .0), rgba(0,0,0, .0), black), radial-gradient(circle, rgba(250,120,250, .0), rgba(0,0,0, .0), rgba(0,0,0, .0), black)',
            }}
          ></div>
        </div>
        <div
